...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=0,
        help=(
            "Concurrent mode: stop after this many source requests. Stripe-split output "
    ...
    if args.max_source_requests:
        parser.error("--max-source-requests requires at least one --source mapping")
