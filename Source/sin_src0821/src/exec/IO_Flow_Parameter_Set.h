...
{
public:
	IO_Flow_Parameter_Set_Trace_Based() { this->Type = Flow_Type::TRACE; this->Trace_Format = Trace_Format_Type::MQSIM_ASCII; this->Relay_Mode = Trace_Replay_Mode::FIXED_COUNT; }
	std::string File_Path;
	Trace_Format_Type Trace_Format;//MQSIM_ASCII (default, backward compatible) or MSRC_CSV
	int Percentage_To_Be_Executed;
	int Relay_Count;
	Trace_Replay_Mode Relay_Mode;//FIXED_COUNT (default, backward compatible) or UNTIL_END_OF_LIFE
