...
public:
	...
	static double End_of_Life_Threshold;//When the remaining over-provisioning ratio (original OP ratio minus the ratio consumed by retired bad blocks) drops to or below this value, the SSD is considered to have reached its end of life
	...
	static SWANS_Parameter_Set SWANS_Parameters;//Parameters of the SWANS RAID-0 SSD-array simulation mode
