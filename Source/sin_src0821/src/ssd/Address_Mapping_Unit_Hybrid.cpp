...
namespace SSD_Components
{
	...
	void Address_Mapping_Unit_Hybrid::Invalidate_lpa_mapping(const stream_id_type stream_id, const LPA_type lpa) {}
	bool Address_Mapping_Unit_Hybrid::Is_lpa_locked_for_gc(const stream_id_type stream_id, const LPA_type lpa) { return false; }
}