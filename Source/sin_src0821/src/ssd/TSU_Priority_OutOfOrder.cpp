...
void TSU_Priority_OutOfOrder::Schedule()
{
         ...
         it++)
    {
        ...
        case Transaction_Type::READ:
            ...
            case Transaction_Source_Type::SWANS://SWANS zone-migration reads are scheduled like GC reads (background I/O)
        ...
        case Transaction_Type::WRITE:
            ...
            case Transaction_Source_Type::MAPPING:
                ...
                break;
            case Transaction_Source_Type::GC_WL:
            case Transaction_Source_Type::SWANS://SWANS zone-migration writes are scheduled like GC writes (background I/O)
