...
namespace SSD_Components
{
	...
	enum class Transaction_Source_Type { USERIO, CACHE, GC_WL, MAPPING, SWANS };//SWANS: interdisk wear-leveling (zone migration) transactions issued by the SWANS RAID-0 array controller
