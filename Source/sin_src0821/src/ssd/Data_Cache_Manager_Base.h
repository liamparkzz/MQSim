...
namespace SSD_Components
{
	...
	public:
		...
		//Directly hands a user request to this cache manager. It is used by an array (RAID) controller
		//to forward the sub-requests of a striped host request to the member SSDs' cache managers.
		void Receive_user_request(User_Request* user_request);
